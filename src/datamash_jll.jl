...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import datamash_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5e3497f2-6421-5a2b-b76c-5131171094e1"))
platforms = [Pkg.Artifacts.unpack_platform(e, "datamash", artifacts_toml) for e in artifacts["datamash"]]
...
if best_platform === nothing
    @debug("Unable to load datamash; unsupported platform $(triplet(platform_key_abi()))")
else
